  ...
  return (
    <>
      ...
      <VerticalHero
        ...
        headline="Muito além do alívio dos sintomas."
        subtitle="Um trabalho profundo na origem dos bloqueios emocionais. Técnica reconhecida e regulamentada para acessar o inconsciente e trabalhar padrões que o pensamento consciente não alcança."
      />
      ...
      <VerticalNotForWho
        items={[
          ...
          'Bloqueios emocionais profundos com origem em padrões inconscientes enraizados, para esses casos, o MEP é mais adequado',
        ]}
        tone="sand"
      />

      {/* Callout diferenciação MEP */}
      <Section tone="cream" size="sm">
        <Container narrow>
          <Callout title="Hipnoterapia avulsa × MEP, qual é a diferença?">
            A hipnoterapia clínica avulsa é a porta de entrada mais acessível ao trabalho com
            hipnoterapia, indicada para questões pontuais e bem delimitadas. O MEP é o
