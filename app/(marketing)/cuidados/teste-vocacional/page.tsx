...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      'Quando o que impede a decisão de carreira não é falta de clareza vocacional, mas sim um bloqueio emocional mais profundo, pode haver uma indicação ao MEP (quando o perfil é de empresário ou executivo). Isso é avaliado ao longo do processo.',
  },
];
            ...
            <div className="bg-cream rounded-2xl p-8 md:p-10 border border-line">
              ...
              <div className="mt-5 space-y-3 text-body text-ink/80">
                ...
                <p>
                  ...
                  emocional mais profundo, o processo pode incluir referência ao MEP para
                  aprofundamento.
                </p>
              </div>
              <div className="mt-6 space-y-2">
