...
export const metadata: Metadata = {
  title: 'Método V — Para destravar emocionalmente',
  description:
...
const VANESSA_BIO = [
  ...
  'Co-fundadora da VCare Essence, acredita que o ambiente é parte do processo terapêutico — não cenário. É nesse princípio que a casa foi construída.',
];
      ...
      <Section tone="cream">
        <Container narrow>
          ...
          <div className="mt-8 space-y-3">
            {[
              {
                text: 'Não é para quem busca terapia semanal de longo prazo — para isso, recomendamos a Camila ou um dos profissionais convidados da casa.',
              },
              {
