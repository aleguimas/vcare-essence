      ...
      <Section tone="cream" size="md" className="border-b border-line">
        <Container>
          ...
          <p className="mt-6 text-lead text-ink/70 max-w-prose">
            Não é locação de sala. É curadoria, você entra numa clínica que tem marca, narrativa e
            cuidado, e essa clínica passa a fortalecer também a sua presença.
          </p>
        </Container>
      </Section>
      ...
      <Section tone="sand">
        <Container narrow>
          ...
          <Heading as="h2" size="h1" className="mt-4">
            Integrar uma clínica é diferente de alugar uma sala.
          </Heading>
          <div className="mt-8 space-y-5 text-body text-ink/80 leading-relaxed">
            <p>
              Espaços de coworking para clínicos vendem infraestrutura. Você chega, usa o espaço,
              vai embora. A marca do espaço não te acrescenta nada, e você não acrescenta nada à
              marca do espaço.
            </p>
            <p>
              A VCare Essence oferece outra coisa: pertencimento a uma marca premium com
              posicionamento claro. Os pacientes que chegam aqui chegam por confiança na clínica,
              e essa confiança se estende a cada profissional que a habita. Os profissionais
              residentes são apresentados na comunicação da clínica, participam da identidade da
              marca e têm acesso ao fluxo de pacientes que ela gera.
            </p>
            <p>
              Em troca, a clínica é seletiva. Não basta ter cadastro, não basta pagar. É necessário
          ...
          <div className="mt-10 space-y-0">
            {[
              ...
              },
              {
                ...
                body: 'Sala mobiliada com identidade visual da clínica, recepção, WiFi e espaço de espera projetado. Você chega e atende, sem preocupação com logística.',
              },
              {
                title: 'Fluxo de pacientes da clínica',
              ...
              {
                title: 'Presença na comunicação da clínica',
      ...
      <Section tone="sand">
        <Container narrow>
          ...
          <div className="mt-10 space-y-8">
            {[
              { n: '1', title: 'Candidatura', body: 'Preencha o formulário abaixo com suas informações, especialidade, abordagem e por que quer integrar a clínica. É uma candidatura, não um cadastro.' },
              ...
              { n: '3', title: 'Residência', body: 'Formalizamos com um contrato com prazo, turnos e regras de comunicação. Você passa a integrar a clínica, com tudo que isso implica.' },
            ].map((step) => (
      ...
      <Section tone="cream">
        <Container narrow>
          ...
          <Heading as="h2" size="h2" className="mt-4">
            Profissionais com formação consolidada e fit com a clínica.
          </Heading>
          ...
          <p className="mt-6 text-small text-muted italic font-sans">
            Estamos selecionando os primeiros profissionais convidados da clínica. Sua candidatura pode ser uma das primeiras.
          </p>
        </Container>
      </Section>
        ...
        <Container narrow>
          ...
          <div className="mt-8 space-y-0">
            {[
              ...
              { q: 'Posso atender meus pacientes atuais aqui?', a: 'Sim. Residentes podem usar o espaço tanto para pacientes próprios quanto, quando aplicável, para pacientes oriundos do fluxo da clínica.' },
