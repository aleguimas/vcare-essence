...
const SENSES = [
  {
    ...
    imageAlt: 'Detalhes olfativos e táteis da VCare Essence — plantas e materiais naturais',
  },
  {
    sense: 'Audição',
    ...
    imageSrc: '',
    imageAlt: 'Interior silencioso da VCare Essence — sala de atendimento',
  },
  {
    sense: 'Visão',
  ...
  },
  {
    ...
    imageSrc: '',
    imageAlt: 'Materiais naturais e táteis da VCare Essence — madeira e tecidos',
  },
  {
    sense: 'Paladar',
    ...
    imageSrc: '',
    imageAlt: 'Ritual de boas-vindas da VCare Essence — chá e café especial',
  },
];
